...
#Create Adaboost Calssifier
adaboost_clf =  AdaBoostClassifier(learning_rate=0.25)
#Fit data into the classifier to create model
adaboost_clf.fit(features_train, labels_train)
#Pass Testing Features to Get A Prediction Out of The Classifier
pred = adaboost_clf.predict(features_test)
